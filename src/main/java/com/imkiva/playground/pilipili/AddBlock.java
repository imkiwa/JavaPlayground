...
public class AddBlock {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        var url = URI.create(
                "http://api.live.bilibili.com/banned_service/v2/Silent/add_block_user"
        );

        var data = "roomid=129215&block_uid=6903512&hour=1&csrf_token=33fbf4f5a30089e083098544411572e4&csrf=33fbf4f5a30089e083098544411572e4&visit_id=";
